...
def main(args: argparse.Namespace):
    ...
    if args.phase == 'test':
        ...
        result_data = [
            [args.arch, args.trade_off, args.epochs, acc1, scorema1,  precisionma1, recallma1,
                scoremi1, precisionmi1,  recallmi1, avg_time, min_time, max_time, elapsed_time],
        ]
    ...
    for epoch in range(args.epochs):
        ...
        # train for one epoch
        train_acc1, train_loss1 = train(train_source_iter, train_target_iter, classifier, mcc_loss, optimizer,
    ...
    csv_filename = osp.join(logger.visualize_directory, 'results.csv')
    result_data = [
        [args.arch, args.epochs, acc1, scorema1,  precisionma1, recallma1, scoremi1,
            precisionmi1,  recallmi1, avg_time, min_time, max_time, elapsed_time],
    ]
    ...
    if not osp.isfile(csv_filename):
        with open(csv_filename, 'w', newline='') as csvfile:
            csv_writer = csv.writer(csvfile)
            csv_writer.writerow(['backbone', 'epoch', 'test_acc', 'F1_marco',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='MCC for Unsupervised Domain Adaptation')
    # dataset parameters
    ...
    parser.add_argument('--temperature', default=2.5,
